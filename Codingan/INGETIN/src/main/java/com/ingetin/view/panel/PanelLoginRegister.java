...
public class PanelLoginRegister extends javax.swing.JLayeredPane {
    ...
    private void initRegister(ActionListener eventRegister) {
        ...
        txtUsername.setPrefixIcon(new ImageIcon("E:/INGETIN/Icon/user.png"));
        txtUsername.setHint("Username");
        register.add(txtUsername, "w 60%");
        
        MyTextField txtEmail = new MyTextField();
        txtEmail.setPrefixIcon(new ImageIcon("E:/INGETIN/Icon/mail.png"));
        txtEmail.setHint("Email");
        register.add(txtEmail, "w 60%");
        
        MyPasswordField txtPass = new MyPasswordField();
        txtPass.setPrefixIcon(new ImageIcon("E:/INGETIN/Icon/pass.png"));
